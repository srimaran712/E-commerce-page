...
function CategoriesM() {
  return (
   <>
    <h2 className="text-black font-bold text-3xl tracking-widest mt-32 ml-10">Categories Men  <img src={RightArrow} alt="right-arrow" className="w-10 ml-5 inline-block"/></h2>
    <div className='w-full p-1 h-1/2 grid grid-cols-4 mt-20 gap-10 ml-12'>

        {CategoryMen.map((items =>{
            return(
